...
export function SignUpGeneralInfo() {
    ...
    const { cnpj, name, telephone } = useAppSelector(({ signUp }) => signUp);
    const [submitted, setSubmitted] = useState(false);
    const validForm =
        cnpj.replaceAll(/[^0-9]/g, '').length === 14 &&
        name &&
    ...
    return (
        <FlexContainer>
            <FlexContent>
                ...
                <Subtitle>Por favor cadastre-se para continuar</Subtitle>
                <Form onSubmit={submit}>
                    ...
                    <Field
                        ...
                        value={telephone}
                        onChange={newValue =>
                            dispatch(signUpActions.setTelephone(newValue))
                        }
                    />
