...
export function SignUpAddress() {
    ...
    if (submitted) return <Redirect to='/signup/account' />;
            ...
            <FlexContent>
                ...
                <Form onSubmit={submit}>
                    ...
                    <Field
                        ...
                        value={address}
                        onChange={newValue =>
                            dispatch(signUpActions.setAddress(newValue))
                        }
                    />
                    <Field
                        title='Bairro'
                        ...
                        value={district}
                        onChange={newValue =>
                            dispatch(signUpActions.setDistrict(newValue))
                        }
                    />
                    <Field
                        title='Cidade'
                    ...
                    <Field
                        ...
                        value={state}
                        onChange={newValue =>
                            dispatch(signUpActions.setState(newValue))
                        }
                    />
