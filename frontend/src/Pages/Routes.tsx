        ...
        <BasePage>
            <BrowserRouter>
                <Switch>
                    ...
                    <Redirect exact from='/signup' to='/signup/info' />
                    <AnonimousRoute exact path='/signin' component={SignIn} />
                    <AnonimousRoute
                        exact
                        path='/signup/info'
                    ...
                    <AnonimousRoute
                        ...
                        component={MenuView}
                    />
                    <UserRoute exact path='/qrcode' component={ViewQRCode} />
                    <UserRoute exact path='/menu/new' component={MenuItemNew} />
                    <UserRoute
                        exact
                        path='/menu/edit'
                    ...
                    />
                    <UserRoute exact path='/menu' component={MenuView} />
                    <UserRoute
                        exact
                    ...
                    <UserRoute exact path='/order/:id' component={OrderView} />
                    <UserRoute
                        exact
                        path='/profile/info'
